/**
 * EditTransactionPage — form to edit an existing transaction.
 * Loads the transaction by ID from the route params and pre-fills the form.
 */
...
function EditTransactionPage() {
  ...
  useEffect(() => {
    if (tx && !initialized) {
      ...
      setShopId(tx.shop_id);
      setPayeeId(tx.payee_id);
      setRemark(tx.remark ?? "");
      setItems(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await updateMutation.mutateAsync({ id: txId, ...parsed.data });
